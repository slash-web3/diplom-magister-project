 ...
 * @returns {Uint8Array}
 */
export function trace_ray(width, height) {
    const ret = wasm.trace_ray(width, height);
...
export class Sphere {
    ...
    static new(center, radius) {
        ...
        const ret = wasm.sphere_new(ptr0, radius);
    ...
    hit(origin, direction) {
        ...
        const ret = wasm.sphere_hit(this.__wbg_ptr, origin.__wbg_ptr, direction.__wbg_ptr);
        return ret;
    }
}
...
export class Vec3 {
     ...
     */
    multiply(t) {
        const ret = wasm.vec3_multiply(this.__wbg_ptr, t);
        return Vec3.__wrap(ret);
    }
    /**
     * @param {Vec3} other
